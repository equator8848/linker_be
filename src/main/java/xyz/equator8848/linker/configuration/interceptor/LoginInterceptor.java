...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse res, Object handler) throws Exception {
        ...
        if (loginUser == null) {
            ...
            simpleRbacApiPermissionValidate(handlerMethod, userFromCacheByUid);
    ...
    private void simpleRbacApiPermissionValidate(HandlerMethod handlerMethod, TbUser userFromCacheByUid) {
